...
<div class="welcome-container" style="max-width: 1280px; margin: 0 auto; font-family: var(--font-sans); color: var(--text-primary);">
    ...
    <section class="welcome-hero welcome-section" style="padding: 64px 40px 52px; border-bottom: 1px solid var(--border-subtle); display: flex; gap: 56px; align-items: flex-start; flex-wrap: wrap;">
        ...
        <div class="welcome-hero-left" style="flex: 1; min-width: 0; max-width: 660px; display: flex; flex-direction: column; gap: 20px;">
            <div style="font: 600 12px/1 var(--font-mono); color: var(--text-muted); letter-spacing: 0.14em; text-transform: uppercase;">
            ...
            <div style="display: inline-flex; flex-direction: column; width: fit-content; margin-top: 2px; margin-bottom: 2px;">
                <div class="welcome-hero-logo" style="font: 700 64px/0.92 var(--font-sans); letter-spacing: -0.04em; color: #f2f4f6; display: flex; align-items: baseline;">
                    ...
                    <span style="font: 600 12px/1 var(--font-mono); color: var(--text-muted); letter-spacing: 0.1em; margin-left: 14px; padding: 3px 6px; border: 1px solid var(--border-medium); border-radius: 2px; background: var(--bg-surface); align-self: flex-start;">.COM</span>
                </div>
            ...
            <p style="margin: 0; font: 400 16.5px/1.65 var(--font-sans); color: #b4bcc4; max-width: 540px; text-wrap: pretty;">
            ...
            <form action="{{ route('home') }}" method="GET" style="display: flex; align-items: center; gap: 10px; max-width: 560px; background: var(--bg-card-alt); border: 1px solid var(--border-strong); border-radius: 3px; padding: 10px 14px; margin-top: 4px;">
                ...
                <input 
                    ...
                    style="flex: 1; background: transparent; border: none; outline: none; font-size: 15px; color: var(--text-primary);"
                >
                <button type="submit" class="btn btn-primary" style="padding: 8px 16px; font-size: 13.5px; font-weight: 600; flex: none;">
            ...
            <div style="display: flex; flex-wrap: wrap; gap: 6px; align-items: center;">
                <span style="font: 500 12px/1 var(--font-mono); color: var(--text-muted); margin-right: 2px;">
                ...
                @foreach($samples as $sample)
                    <a href="{{ isset($sample->id) && $sample->id ? route('films.show', $sample->id) : route('home', ['q' => $sample->title]) }}" 
                       style="font: 400 12.5px/1 var(--font-sans); padding: 6px 10px; border: 1px solid var(--border-subtle); border-radius: 2px; background: var(--bg-surface); color: var(--text-secondary); transition: border-color 0.1s ease;">
                        {{ $sample->title }}
                    </a>
                @endforeach
            </div>
        ...
        <div class="welcome-preview-card" style="width: 420px; flex: none; max-width: 100%; border: 1px solid var(--border-default); border-radius: 3px; background: var(--bg-card); padding: 20px;">
            <div style="display: flex; align-items: baseline; gap: 9px; margin-bottom: 14px;">
                <span style="font: 600 13.5px/1 var(--font-sans); color: var(--text-primary);">
                    {{ __('welcome.example_label') }}
                </span>
                <span style="margin-left: auto; font: 500 11px/1 var(--font-mono); color: var(--text-muted); letter-spacing: 0.05em;">
                    POOR THINGS · 2:21:00
                </span>
            </div>
            ...
            <div style="position: relative; height: 18px; margin-bottom: 10px;">
                <span style="position: absolute; top: 4px; left: 0%; font: 400 10.5px/1 var(--font-mono); color: #565e67;">0:00</span>
                <span style="position: absolute; top: 4px; left: 21.3%; transform: translateX(-50%); font: 400 10.5px/1 var(--font-mono); color: #565e67;">0:30</span>
                <span style="position: absolute; top: 4px; left: 42.5%; transform: translateX(-50%); font: 400 10.5px/1 var(--font-mono); color: #565e67;">1:00</span>
                <span style="position: absolute; top: 4px; left: 63.8%; transform: translateX(-50%); font: 400 10.5px/1 var(--font-mono); color: #565e67;">1:30</span>
                <span style="position: absolute; top: 4px; left: 85.1%; transform: translateX(-50%); font: 400 10.5px/1 var(--font-mono); color: #565e67;">2:00</span>
                <span style="position: absolute; top: 4px; right: 0%; font: 400 10.5px/1 var(--font-mono); color: #565e67;">2:21</span>
            </div>
            ...
            <div style="display: flex; flex-direction: column; gap: 1px; border-top: 1px solid var(--border-subtle);">
                <div style="display: flex; align-items: center; gap: 10px; padding: 7px 0; border-bottom: 1px solid var(--border-subtle);">
                    ...
                    <span style="font: 500 13px/1 var(--font-mono); color: var(--text-primary);">00:18:40 – 00:19:25</span>
                    <span style="font: 500 11.5px/1 var(--font-sans); color: var(--color-suggestive);">{{ __('categories.suggestive') }}</span>
                    <span style="margin-left: auto; font: 600 10.5px/1 var(--font-mono); letter-spacing: 0.04em; padding: 3px 6px; border: 1px solid #2e4a36; border-radius: 2px; background: #16211a; color: #7cc08a;">
                        VERIFIED
                    </span>
                </div>
                <div style="display: flex; align-items: center; gap: 10px; padding: 7px 0; border-bottom: 1px solid var(--border-subtle);">
                    <span style="width: 3px; height: 15px; flex: none; background: var(--color-nudity); border-radius: 1px;"></span>
                    <span style="font: 500 13px/1 var(--font-mono); color: var(--text-primary);">00:31:10 – 00:33:05</span>
                    <span style="font: 500 11.5px/1 var(--font-sans); color: var(--color-nudity);">{{ __('categories.nudity') }}</span>
                    <span style="margin-left: auto; font: 600 10.5px/1 var(--font-mono); letter-spacing: 0.04em; padding: 3px 6px; border: 1px solid #2e4a36; border-radius: 2px; background: #16211a; color: #7cc08a;">
                        VERIFIED
                    </span>
                </div>
                <div style="display: flex; align-items: center; gap: 10px; padding: 7px 0; border-bottom: 1px solid var(--border-subtle);">
                    ...
                    <span style="font: 500 13px/1 var(--font-mono); color: var(--text-primary);">00:47:22 – 00:49:58</span>
                    <span style="font: 500 11.5px/1 var(--font-sans); color: var(--color-sex);">{{ __('categories.sex_scene') }}</span>
                    <span style="margin-left: auto; font: 600 10.5px/1 var(--font-mono); letter-spacing: 0.04em; padding: 3px 6px; border: 1px solid #2e4a36; border-radius: 2px; background: #16211a; color: #7cc08a;">
                        VERIFIED
                    </span>
                </div>
                <div style="display: flex; align-items: center; gap: 10px; padding: 7px 0; border-bottom: 1px solid var(--border-subtle);">
                    <span style="width: 3px; height: 15px; flex: none; background: var(--color-nudity); border-radius: 1px;"></span>
                    <span style="font: 500 13px/1 var(--font-mono); color: var(--text-primary);">00:58:05 – 00:59:12</span>
                    <span style="font: 500 11.5px/1 var(--font-sans); color: var(--color-nudity);">{{ __('categories.nudity') }}</span>
                    <span style="margin-left: auto; font: 600 10.5px/1 var(--font-mono); letter-spacing: 0.04em; padding: 3px 6px; border: 1px solid #303740; border-radius: 2px; background: #1b1f24; color: #98a0a8;">
                        COMMUNITY
                    </span>
                </div>
            </div>

            <div style="font: 400 11.5px/1.6 var(--font-sans); color: var(--text-muted); padding-top: 10px;">
    ...
    <section class="welcome-stats-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); border-bottom: 1px solid var(--border-subtle);">
        <div class="welcome-stats-item" style="padding: 22px 36px; border-right: 1px solid var(--border-subtle); display: flex; flex-direction: column; gap: 5px;">
            <span style="font: 500 27px/1 var(--font-mono); color: #f2f4f6; letter-spacing: -0.02em;">
                {{ number_format($totalFilms, 0, ',', ' ') }}
            </span>
            <span style="font: 400 12.5px/1.4 var(--font-sans); color: var(--text-muted);">
    ...
    <section id="how-it-works" class="welcome-section" style="padding: 48px 40px; border-bottom: 1px solid var(--border-subtle);">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 40px;">
            ...
            <div style="display: flex; flex-direction: column; gap: 9px; padding-top: 14px; border-top: 1px solid var(--border-medium);">
                ...
                <span style="font: 600 20px/1.25 var(--font-serif); color: #f2f4f6;">
                    {{ __('welcome.how_it_works_step1_title') }}
                </span>
                <span style="font: 400 14.5px/1.7 var(--font-sans); color: #98a0a8; text-wrap: pretty;">
    ...
    <section class="welcome-section" style="padding: 48px 40px; border-bottom: 1px solid var(--border-subtle); display: flex; gap: 56px; align-items: flex-start; flex-wrap: wrap;">
        <div style="max-width: 300px; width: 100%; flex: none; display: flex; flex-direction: column; gap: 10px;">
            <span style="font: 600 12px/1 var(--font-mono); color: var(--text-muted); letter-spacing: 0.14em; text-transform: uppercase;">
                {{ __('welcome.never_do_title') }}
            </span>
            <span style="font: 600 25px/1.25 var(--font-serif); color: #f2f4f6; text-wrap: pretty;">
        ...
        <div style="flex: 1; min-width: 0; display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 16px 36px;">
            <div style="display: flex; gap: 11px;">
                ...
                <span style="font: 400 14.5px/1.6 var(--font-sans); color: #b4bcc4;">
    ...
    <section class="welcome-shelf-section welcome-section" style="padding: 40px 40px 44px; border-bottom: 1px solid var(--border-subtle);">
        <div style="display: flex; align-items: baseline; gap: 12px; margin-bottom: 18px; flex-wrap: wrap;">
            <span style="font: 600 16px/1 var(--font-sans); color: var(--text-primary);">
                {{ __('welcome.clean_shelf_title') }}
            </span>
            <span style="font: 400 12px/1 var(--font-mono); color: var(--text-muted); letter-spacing: 0.04em;">
                {{ __('welcome.clean_shelf_subtitle') }}
            </span>
            <a href="{{ $cleanVerifiedFilms > 0 ? route('home', ['category' => 'clean']) : route('home') }}" style="margin-left: auto; font: 500 13px/1 var(--font-sans); color: var(--color-blue-link);">
                ...
                <a href="{{ isset($film->id) && $film->id ? route('films.show', $film->id) : route('home', ['q' => $film->title]) }}" 
                   style="display: flex; flex-direction: column; gap: 7px; text-decoration: none;">
                    <div style="position: relative; aspect-ratio: 2/3; background: repeating-linear-gradient(135deg,#1b1f24 0 5px,#171b20 5px 10px); border: 1px solid var(--border-default); border-radius: 2px; overflow: hidden;">
                        ...
                        @else
                            <div style="display: flex; align-items: center; justify-content: center; height: 100%; font: 500 11.5px/1.2 var(--font-mono); color: var(--text-muted); text-align: center; padding: 8px;">
                                {{ $film->title }}
                            </div>
                        @endif
                        <span style="position: absolute; top: 0; left: 0; right: 0; height: 3px; background: var(--color-clean);"></span>
                    </div>
                    <div style="font: 600 13.5px/1.25 var(--font-serif); color: #d6dbe0; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                        {{ $film->title }}
                    </div>
    ...
    <section class="welcome-section" style="padding: 48px 40px; display: flex; align-items: flex-end; gap: 40px; flex-wrap: wrap;">
        <div style="flex: 1; min-width: 0;">
            <div style="font: 600 29px/1.25 var(--font-serif); color: #f2f4f6; max-width: 520px; text-wrap: pretty; margin-bottom: 10px;">
                {{ __('welcome.cta_title') }}
            </div>
            <div style="font: 400 14.5px/1.7 var(--font-sans); color: #98a0a8; max-width: 480px;">
        ...
        <div style="flex: none; display: flex; gap: 12px; flex-wrap: wrap;">
            ...
            <a href="{{ route('guidelines') }}" class="btn btn-secondary" style="padding: 12px 22px; font-size: 14px; font-weight: 500;">
    ...
    <section class="welcome-section" style="display: flex; gap: 40px; align-items: flex-start; padding: 26px 40px; border-top: 1px solid var(--border-subtle); background: #101317; flex-wrap: wrap;">
        <div style="display: flex; gap: 16px; align-items: flex-start; max-width: 620px;">
            ...
            <div style="display: flex; flex-direction: column; gap: 6px;">
                ...
                <span style="font: 400 12.5px/1.7 var(--font-sans); color: var(--text-muted);">
        ...
        <div style="display: flex; flex-direction: column; gap: 6px; max-width: 320px;">
            <span style="font: 600 11px/1 var(--font-mono); color: var(--text-muted); letter-spacing: 0.1em; text-transform: uppercase;">
                {{ __('welcome.footer_scene_data_title') }}
            </span>
            <span style="font: 400 12.5px/1.7 var(--font-sans); color: #98a0a8;">
                {{ __('welcome.footer_scene_data_body') }}
            </span>
            <div style="display: flex; gap: 10px; margin-top: 4px; font-size: 12.5px;">
